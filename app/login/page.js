  ...
  return (
    <div className='grow shrink'>
      <main className='flex flex-col-reverse w-screen h-screen min-h-screen overflow-x-hidden md:flex-row md:items-center grow shrink xl:overflow-hidden'>
        <section className='bg-none bg-no-repeat bg-cover w-[100%] h-screen flex flex-col justify-center items-center shrink grow md:w-[55%] md:bg-[url("/background-login.png")] sm:mt-10 '>         
